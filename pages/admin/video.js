                                ...
                                <div className={`${value.togle ? " w-full lg:w-4/5" : "w-full"} absolute right-0`}>
                                        ...
                                        <div className="mx-9 bg-gray-50 p-2 rounded-sm border ">
                                            ...
                                            <div className="flex">
                                                ...
                                                <div className="w-1/4 "><input type="text" placeholder="Url Video On Youtube" className="text-sm p-1 pl-4 outline-none bg-gray-50 border border-gray-400 rounded-md"/></div>
